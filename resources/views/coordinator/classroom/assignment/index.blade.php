        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="d-flex justify-content-between">
                    @role('Teacher')
                        <button class="btn mb-3" style="border-radius: 50px; color: white; background: #3a7fdf; padding: 10px 20px;" data-bs-toggle="modal" data-bs-target="#addAssignment">
                        ...
                        <!-- Modal -->
                        <div class="modal" id="addAssignment" tabindex="-1" aria-labelledby="selectCourse" aria-hidden="true">
